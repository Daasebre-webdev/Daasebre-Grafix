...
export default function AIGenerator() {
 ...
 // In your AI generator component
const saveGeneratedProjects = (projects: Project[]) => {
  // Save to all storage locations
  const existingAllProjects = JSON.parse(localStorage.getItem('allProjects') || '[]');
  ...
  localStorage.setItem('allProjects', JSON.stringify([...existingAllProjects, ...newProjects]));
  localStorage.setItem('userProjects', JSON.stringify([...existingUserProjects, ...newProjects]));
  
  // Also save to generatedProjects for backward compatibility
  const existingGenerated = JSON.parse(localStorage.getItem('generatedProjects') || '[]');
  localStorage.setItem('generatedProjects', JSON.stringify([...existingGenerated, ...newProjects]));
  
  // Dispatch event to update bookmarks
  ...
  return (
    <div className={styles["dashboard-container"]}>
      ...
      <div className={styles["menu"]}>
        ...
        <span className={styles["menu-separator"]}>|</span>
        <Link href="/ai" className={styles["menu-link-active"]}>Generate Your Own Project</Link>
        <span className={styles["menu-separator"]}>|</span>
